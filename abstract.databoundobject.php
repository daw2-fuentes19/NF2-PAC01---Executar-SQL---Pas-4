...
abstract class DataBoundObject {
   ...
   abstract protected function DefineTableName2();
   abstract protected function DefineRelationMap2();  
   abstract protected function DefineTableName3();
   abstract protected function DefineRelationMap3();  
   ...
   public function __construct(PDO $objPDO, $id = NULL) {
      ...
      $this->strTableName2 = $this->DefineTableName2();
      $this->arRelationMap2 = $this->DefineRelationMap2();
      $this->strTableName3 = $this->DefineTableName3();
      $this->arRelationMap3 = $this->DefineRelationMap3();
...
public function Save2() {
      if (isset($this->ID)) {
         $strQuery = 'UPDATE "' . $this->strTableName2 . '" SET ';
         foreach ($this->arRelationMap2 as $key => $value) {
            eval('$actualVal = &$this->' . $value . ';');
            if (array_key_exists($value, $this->arModifiedRelations)) {
               $strQuery .= '"' . $key . "\" = :$value, ";
            };
         ...
         $strValueList = "";
         $strQuery = 'INSERT INTO "' . $this->strTableName2 . '"(';
         foreach ($this->arRelationMap2 as $key => $value) {
            eval('$actualVal = &$this->' . $value . ';');
            if (isset($actualVal)) {
               if (array_key_exists($value, $this->arModifiedRelations)) {
   ...
   public function Save3() {
      if (isset($this->ID)) {
         $strQuery = 'UPDATE "' . $this->strTableName3 . '" SET ';
         foreach ($this->arRelationMap3 as $key => $value) {
            eval('$actualVal = &$this->' . $value . ';');
            if (array_key_exists($value, $this->arModifiedRelations)) {
               $strQuery .= '"' . $key . "\" = :$value, ";
            };
         ...
         $strValueList = "";
         $strQuery = 'INSERT INTO "' . $this->strTableName3 . '"(';
         foreach ($this->arRelationMap3 as $key => $value) {
            eval('$actualVal = &$this->' . $value . ';');
            if (isset($actualVal)) {
               if (array_key_exists($value, $this->arModifiedRelations)) {
